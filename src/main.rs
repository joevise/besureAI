...
fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        Commands::Add { content, from_file, entry_type, context, tags } => {
            cli::commands::cmd_add_from_args(content.as_deref(), from_file.as_deref(), &entry_type, context.as_deref(), &tags)
        }
