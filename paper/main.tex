...
\begin{tikzpicture}[
    ...
    dash/.style={rounded corners=4pt, draw=layer3color, fill=layer3color!10, minimum width=2.5cm, minimum height=0.8cm, font=\small, align=center},
...
% Dashboard
\node[dash] (dash) at (5, -1.5) {Web Dashboard};
